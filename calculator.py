...
calculator.maxsize(320, 240)
calculator.minsize(320, 240)
...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.zeroButton = Button(self,bg='cyan', font=("Helvetica", 15), text="0", borderwidth=5,
                                 command=lambda: self.appendToDisplay("0"))
        self.zeroButton.grid(row=4, column=0, columnspan=2, sticky="NWNESWSE")

        self.dotButton = Button(self, font=("Helvetica", 15), text=".", borderwidth=5,
                                command=lambda: self.appendToDisplay("."))
        self.dotButton.grid(row=4, column=2, sticky="NWNESWSE")

        self.plusButton = Button(self, font=("Helvetica", 15), text="+", borderwidth=5,
                                 command=lambda: self.appendToDisplay("+"))
